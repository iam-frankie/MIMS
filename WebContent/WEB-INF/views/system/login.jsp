...
<script type="text/javascript">
	...
	function changeCpacha(){
		...
		document.querySelector(".login-button").onclick = function(){
				var username = $("#username").val(); //接受文本框输入的值，用户名，密码，验证码，中转一下，方便等会提交
				...
				//ajax向上提交数据
				$.ajax({
					url:'login',						//请求地址，对应controller里面的login函数
					data:{username:username,password:password,cpacha:cpacha}, 
					/*注意花括号，属性的名字要
					和entity里的实体类、controller里面的属性名称对应
...
//							window.location = '../admin/supplier/list';
//							alert("登录成功！");
						}else{
